...
class MarketingController extends Controller
{
	...
	public function getDataIronsource2()
	{
		set_time_limit(3600);
	...
	public function getDataIronsource3()
	{
		set_time_limit(3600);
	...
	public function getDataAdwords1()
	{
		set_time_limit(3600);
	...
	public function getDataSearchads()
	{
		set_time_limit(3600);
	...
	public function getDataApplovin1()
	{
		set_time_limit(3600);
	...
	public function getDataApplovin2()
	{
		set_time_limit(3600);
	...
	public function getDataApplovin3()
	{
		set_time_limit(3600);
	...
	public function getSendNotiDung()
	{
		...
		$info = [
			...
			"to" => "erBnqup8Tf-qpO-1IP0wmN:APA91bHsCbbJ20eE9RqkC02caBdzmqvO8oRDYOEWBsE8a3QlRMEj1otRC-htahWnECe39rbtQYGEv0MxFDhKWS5pdmZatsFv_ZTmdhTXkZhXvct0DihI5F2ff07nRA44vVIrp8lEZMEl"
		];
		$platform = 'ANDROID';
		if ($platform == 'IOS' || $platform == 'ios') {
			$serverkey = "AAAAGE0t6F0:APA91bFeOGyrCyCh172XGerOq-cdiVcoSd9wyq6eSBgFfwhqBTT_JQq2J5L8pmIIGdK49gnPFmpVPcBcFD5lPfpsstTRDMZ1jIEi7UHmWFkj8c3pzGVNJ9_FqhRKyCwLy9nQ853HauPc";
